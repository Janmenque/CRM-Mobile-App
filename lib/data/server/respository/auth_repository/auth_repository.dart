...
import 'package:hrm_app/data/model/auth_response/response_change_password_profile.dart';
import 'package:hrm_app/data/model/auth_response/response_change_passwrod.dart';
...
class AuthRepository {
  ...
  static Future<ApiResponse<ResponseLogin>> getLogin(
    ...
    try {
      ...
      var response = await ApiService.getDio()!.post("/central-login", data: bodyLogin);
      EasyLoading.dismiss();
